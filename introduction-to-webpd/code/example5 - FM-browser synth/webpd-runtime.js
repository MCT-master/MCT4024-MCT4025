var WebPdRuntime = (function (exports) {
   ...
   * along with this program. If not, see <http://www.gnu.org/licenses/>.
   */
  const Var$1 = (typeName, name, value) =>
    _preventToString$1({
      astType: "Var",
      name,
      type: typeName,
  ...
  const ConstVar$1 = (typeName, name, value) =>
    _preventToString$1({
      astType: "ConstVar",
      name,
      type: typeName,
  ...
  const Sequence$1 = (content) => ({
    astType: "Sequence",
    content: _processRawContent$1(
      _intersperse$1(
        content,
        countTo$1(content.length - 1).map(() => "\n")
      )
    ),
  });
  const ast$1 = (strings, ...content) =>
    _preventToString$1({
      astType: "Sequence",
    ...
    const flattenedAndFiltered = content.flatMap((element) => {
      if (typeof element === "string") {
        ...
        if (element === null) {
          ...
          return _processRawContent$1(
            _intersperse$1(
              element,
              countTo$1(element.length - 1).map(() => "\n")
            )
          );
        } else if (
  ...
  const bufCore$1 = () =>
    Sequence$1([
      ...
      Func$1("buf_clear", [Var$1("buf_SoundBuffer", "buffer")], "void")`
        buffer.data.fill(0)
    `,
      /** Erases all the content from the buffer */
      Func$1("buf_create", [Var$1("Int", "length")], "buf_SoundBuffer")`
        return {
  ...
  const bufPushPull$1 = {
    codeGenerator: () =>
      Sequence$1([
        ...
        Func$1(
          "buf_pushBlock",
          [Var$1("buf_SoundBuffer", "buffer"), Var$1("FloatArray", "block")],
          "Int"
        )`
         ...
         */
        Func$1("buf_pullSample", [Var$1("buf_SoundBuffer", "buffer")], "Float")`
  ...
  const msg$1 = {
    codeGenerator: ({ target }) => {
      const declareFuncs = {
        msg_create: Func$1(
          "msg_create",
          [Var$1("MessageTemplate", "template")],
          "Message"
        ),
        msg_writeStringToken: Func$1(
        ...
        msg_readStringToken: Func$1(
          "msg_readStringToken",
          [Var$1("Message", "message"), Var$1("Int", "tokenIndex")],
          "string"
        ),
        msg_readFloatToken: Func$1(
          "msg_readFloatToken",
          [Var$1("Message", "message"), Var$1("Int", "tokenIndex")],
          "MessageFloatToken"
        ),
        msg_getLength: Func$1(
          "msg_getLength",
          [Var$1("Message", "message")],
          "Int"
        ),
        msg_getTokenType: Func$1(
          "msg_getTokenType",
          [Var$1("Message", "message"), Var$1("Int", "tokenIndex")],
          "Int"
        ),
        msg_isStringToken: Func$1(
          "msg_isStringToken",
          [Var$1("Message", "message"), Var$1("Int", "tokenIndex")],
          "boolean"
        ),
        msg_isFloatToken: Func$1(
          "msg_isFloatToken",
          [Var$1("Message", "message"), Var$1("Int", "tokenIndex")],
          "boolean"
        ),
        msg_isMatching: Func$1(
          "msg_isMatching",
          [
            Var$1("Message", "message"),
    ...
    codeGenerator: ({ target }) => {
      ...
      return Sequence$1([
        ...
        ConstVar$1(
          ...
          FS_OPERATION_SUCCESS$1.toString()
        ),
        ConstVar$1(
          "Int",
          "FS_OPERATION_FAILURE",
          FS_OPERATION_FAILURE$1.toString()
        ),
        ...
        Func$1(
          ...
          "Message"
            ...
            `,
        Func$1(
          "_fs_assertOperationExists",
          [Var$1("fs_OperationId", "id"), Var$1("string", "operationName")],
          "void"
        )`
      ...
      Sequence$1([
        ...
        Func$1(
          ...
          "void"
            ...
            // Finish cleaning before calling the callback in case it would throw an error.
            ${ConstVar$1(
              "fs_OperationCallback",
              "callback",
              "_FS_OPERATIONS_CALLBACKS.get(id)"
            )}
            callback(id, status)
  ...
  const fsSoundStreamCore$1 = {
    ...
    imports: [
      Func$1(
        ...
        [Var$1("fs_OperationId", "id"), Var$1("fs_OperationStatus", "status")],
        "void"
      )``,
    ],
  ...
  ({
    codeGenerator: () =>
      Sequence$1([
        Func$1(
          ...
          "fs_OperationId"
            ...
            for (${Var$1(
              ...
              "channel",
              "0"
            )}; channel < soundInfo.channelCount; channel++) {
        ...
        `,
        Func$1(
          "x_fs_onSoundStreamData",
          [Var$1("fs_OperationId", "id"), Var$1("FloatArray[]", "block")],
          "Int"
        )`
  ...
  const streamLoop = (node, operationId, framesAvailableInEngine) => {
    ...
    const framesToSend =
      BUFFER_HIGH - (framesAvailableInEngine - secondsToThreshold * sampleRate);
    setTimeout(() => {
  ...
  const ConstVar = (typeName, name, value) =>
    _preventToString({
      astType: "ConstVar",
      name,
      type: typeName,
  ...
  const bufCore = () =>
    Sequence([
      ...
      /** Erases all the content from the buffer */
      Func("buf_clear", [Var("buf_SoundBuffer", "buffer")], "void")`
        buffer.data.fill(0)
    `,
      /** Erases all the content from the buffer */
      Func("buf_create", [Var("Int", "length")], "buf_SoundBuffer")`
        return {
            data: createFloatArray(length),
            length: length,
            writeCursor: 0,
  ...
  const bufPushPull = {
    codeGenerator: () =>
      Sequence([
        ...
        Func(
          "buf_pushBlock",
          [Var("buf_SoundBuffer", "buffer"), Var("FloatArray", "block")],
          "Int"
        )`
            if (buffer.pullAvailableLength + block.length > buffer.length) {
                throw new Error('buffer full')
         ...
         * unavailable for subsequent readers with the same operation.
         */
        Func("buf_pullSample", [Var("buf_SoundBuffer", "buffer")], "Float")`
            if (buffer.pullAvailableLength <= 0) {
                return 0
            }
            ${ConstVar(
  ...
  const msg = {
    codeGenerator: ({ target }) => {
      const declareFuncs = {
        ...
        msg_readStringToken: Func(
          "msg_readStringToken",
          [Var("Message", "message"), Var("Int", "tokenIndex")],
          "string"
        ),
        msg_readFloatToken: Func(
          "msg_readFloatToken",
          [Var("Message", "message"), Var("Int", "tokenIndex")],
          "MessageFloatToken"
        ),
        ...
        msg_getTokenType: Func(
          "msg_getTokenType",
          [Var("Message", "message"), Var("Int", "tokenIndex")],
          "Int"
        ),
        msg_isStringToken: Func(
          "msg_isStringToken",
          [Var("Message", "message"), Var("Int", "tokenIndex")],
          "boolean"
        ),
        msg_isFloatToken: Func(
          "msg_isFloatToken",
          [Var("Message", "message"), Var("Int", "tokenIndex")],
          "boolean"
        ),
        ...
        msg_display: Func("msg_display", [Var("Message", "message")], "string"),
      };
      if (target === "assemblyscript") {
        return Sequence([
          `
          ...
          Func(
            ...
            "MessageHeader"
                    ...
                    return message.tokenTypes
                `,
          Func("x_msg_createTemplate", [Var("i32", "length")], "Int32Array")`
                    return new Int32Array(length)
                `,
          // =========================== MSG API
          declareFuncs.msg_create`
          ...
          Func("_msg_computeHeaderLength", [Var("Int", "tokenCount")], "Int")`
                    return 1 + tokenCount * 2 + 1
                `,
          Func(
            "_msg_unpackTokenCount",
  ...
  const fsCore = {
    codeGenerator: ({ target }) => {
      ...
      return Sequence([
        ...
        Func(
          "_fs_assertOperationExists",
          [Var("fs_OperationId", "id"), Var("string", "operationName")],
          "void"
        )`
                if (!_FS_OPERATIONS_IDS.has(id)) {
                    throw new Error(operationName + ' operation unknown : ' + id.toString())
  ...
  const getFloatArrayType = (bitDepth) =>
  ...
  const instantiateWasmModule = async (wasmBuffer, wasmImports = {}) => {
    ...
    const wasmExports = instanceAndModule.instance.exports;
    return instanceAndModule.instance;
  };
  ...
  const createFsModule = (rawModule) => {
    ...
    rawModule.i_fs_openSoundWriteStream = (...args) =>
      fs.onOpenSoundWriteStream(...args);
    rawModule.i_fs_sendSoundStreamData = (...args) =>
      fs.onSoundStreamData(...args);
    rawModule.i_fs_openSoundReadStream = (...args) =>
      fs.onOpenSoundReadStream(...args);
    rawModule.i_fs_closeSoundStream = (...args) =>
  ...
  const createCommonsModule = (rawModule, bitDepth) => {
    ...
    return createModule(rawModule, {
      ...
      setArray: {
        type: "proxy",
        value: (arrayName, array) =>
          rawModule.commons_setArray(arrayName, new floatArrayType(array)),
      },
    });
  };
